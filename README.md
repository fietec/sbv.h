...
A simple stb-style string builder and string view library for C.
...
Output:
```
Original string: '  Hello, world! Welcome to sbv library demo.  '
Trimmed string: 'Hello, world! Welcome to sbv library demo.'
Words:
 - Hello,
 - world!
 - Welcome
